...
struct ClusterConductorWorker : NewIWorker {
  ClusterConductorWorker(ExecutionNumber executionNumber, ServerID serverId,
...
struct SingleServerConductorWorker : NewIWorker {
  SingleServerConductorWorker(ExecutionNumber executionNumber,
